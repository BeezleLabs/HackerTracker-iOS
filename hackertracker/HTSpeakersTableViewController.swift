...
class HTSpeakersTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let storyboard = self.storyboard, let svc = storyboard.instantiateViewController(withIdentifier: "HTSpeakerViewController") as? HTSpeakerViewController {
            svc.speaker = self.speakerSections[indexPath.section].speakers[indexPath.row]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "speakerSegue") {
            ...
            NSLog("setting nvc.speaker to: \(svc.speaker?.name!)")
